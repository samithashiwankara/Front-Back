...
import './userAccount.css'; // Import the updated CSS file for the UAccount component
  ...
  return (
    <>
      ...
      <div className="text-content">
        <h2><strong>Welcome, User!</strong></h2>
        <h2>Sign Language Recognition with Advanced Computer Vision</h2>
        <p>Your account provides access to cutting-edge sign language recognition tools, enabling real-time translation of sign language into text.</p>
        <p>Explore our model page to see the latest advancements, or log out to secure your account.</p>
      </div>
    </>
  );
}
