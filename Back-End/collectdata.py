...
directory='E:/Final Project/FrontEnd-BackEnd/Back-End/.Image'
while True:
    _,frame=cap.read()
    count = {
            ...
            #  ';': len(os.listdir(directory+"/Space"))
             }
    ...
    cv2.imshow("Signal Capturing",frame[40:400,0:300])
    ...
    # if interrupt  == (';'):
    #     cv2.imwrite(directory+'Space/'+str(count[';'])+'.png',frame)
    elif interrupt & 0xFF == ord('/'):  # Press '/' to exit
        break
